		...
		var vimeoready_auto = function(player_id,autoplay) {
			...
			var updateHTML5Size = function(pc,container) {
				...
				********************************/
				...
				var callCaptionLoops = function(nextcaption,fCategory) {
									...
									nextcaption.find('.rs-pendulum').each(function() {
										...
										if (el.data('timeline')==undefined) {
											...
											startdeg = startdeg * fCategory;
											enddeg = enddeg * fCategory;
									...
									nextcaption.find('.rs-wave').each(function() {
										...
										if (el.data('timeline')==undefined) {
											...
											var angle= el.data('angle')==undefined ? 10 : el.data('angle'),
												...
												angle = angle*fCategory;
												radius = radius * fCategory;
	...
	***********************************************/
	var calculateKenBurnScales = function(proc,sloth,opt) {
				...
				if (ow / oh > opt.width / opt.height) {
					var fCategory = (opt.container.width() /ow);
					var nheight = oh * fCategory;
					var hfCategory = (nheight / opt.container.height())*proc;
					proc = proc * (100/hfCategory);
					hfCategory = 100;
					proc = proc;
					return (proc+"% "+hfCategory+"%"+" 1");
				} else {
					var fCategory = (opt.container.width() /ow);
					var nheight = oh * fCategory;
					var hfCategory = (nheight / opt.container.height())*proc;
					return (proc+"% "+hfCategory+"%");
				}
			}
