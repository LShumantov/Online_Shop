							...
							<div class="widget_logo">
								...
								<ul>
									<li>
										...
										<div class="wl_right">
											<a href="#">Address : 09 Ecommerceshop, Design Street,  Victoria, Australia</a>
										</div>
									</li>
									<li><a href="#"><i class="fa fa-envelope-o"></i>E-mail : Info@Ecommerceshop.com</a>
									</li>
									<li><a href="#"><i class="fa fa-phone"></i>phone : +01 123 456 78</a>
									</li>
								</ul>
							</div>
						</div>
